...
_LOG_COLOR = "#c8c8c8"     # светло-серый — строки лога событий
...
_LOG_LINE_H = 18           # шаг строк лога по вертикали
...
class OverlayView:
    ...
    def _draw_status(self, running: bool) -> None:
        ...
        for ts, line in EVENT_LOG.recent():
            ...
            self._canvas.create_text(12, y, text=f"{stamp}  {line}",
                                     fill=_LOG_COLOR, anchor="nw",
                                     font=("Consolas", 10))
            y += _LOG_LINE_H
